...
const QUNOOT = {
  ...
  arabic:
    'اللَّهُمَّ اهْدِنِي فِيمَنْ هَدَيْتَ، وَعَافِنِي فِيمَنْ عَافَيْتَ، وَتَوَلَّنِي فِيمَنْ تَوَلَّيْتَ، وَبَارِكْ لِي فِيمَا أَعْطَيْتَ، وَقِنِي شَرَّ مَا قَضَيْتَ، إِنَّكَ تَقْضِي وَلَا يُقْضَىٰ عَلَيْكَ، إِنَّهُ لَا يَذِلُّ مَن وَالَيْتَ، تَبَارَكْتَ رَبَّنَا وَتَعَالَيْتَ',
  translit:
    'اَللّٰہُمَّ اہْدِنِیْ فِیْمَنْ ہَدَیْت، وَعَافِنِیْ فِیْمَنْ عَافَیْت، وَتَوَلَّنِیْ فِیْمَنْ تَوَلَّیْت، وَبَارِکْ لِیْ فِیْمَا اَعْطَیْت، وَقِنِیْ شَرَّ مَا قَضَیْت، اِنَّکَ تَقْضِیْ وَلَا یُقْضٰی عَلَیْک، اِنَّہٗ لَا یَذِلُّ مَنْ وَّالَیْت، تَبَارَکْتَ رَبَّنَا وَتَعَالَیْت',
  meaning:
    'اے اللہ! مجھے ہدایت دے اُن لوگوں میں جنہیں تُو نے ہدایت دی، مجھے عافیت دے اُن میں جنہیں تُو نے عافیت دی، میرا کارساز بن جا اُن میں جن کا تُو کارساز بنا، اور جو کچھ تُو نے مجھے دیا اُس میں برکت عطا فرما۔ اور جو تُو نے مقدر کیا اُس کی برائی سے مجھے بچا۔ بے شک تُو ہی فیصلہ کرتا ہے، تیرے خلاف کوئی فیصلہ نہیں کر سکتا۔ جس کا تُو دوست بن جائے وہ ذلیل نہیں ہوتا۔ اے ہمارے رب! تُو بابرکت اور بلند و بالا ہے۔',
  audio: 'qunoot.mp3',
}
