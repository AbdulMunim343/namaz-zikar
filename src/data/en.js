...
export const UI = {
  ur: {
    ...
    fardNote: 'یہاں صرف فرض رکعتیں سکھائی گئی ہیں۔ سنتیں بھی اسی طریقے سے پڑھی جاتی ہیں۔',
  ...
  en: {
    ...
    fardNote: 'Only the fard rak‘ahs are taught here. The sunnah rak‘ahs are prayed the same way.',
